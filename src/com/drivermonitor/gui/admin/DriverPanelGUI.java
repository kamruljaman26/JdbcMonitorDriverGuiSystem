...
import com.drivermonitor.database.dao.AdminDAO;
...
public class DriverPanelGUI extends Scene implements EventHandler<ActionEvent> {

    // set root layout based on need
    private static final VBox root = new VBox(15);
    private static final int WIDTH = 600;
    private static final int HEIGHT = 400;
    private static final String TITLE = "Admin Panel : Driver";
    ...
    public DriverPanelGUI(Stage primaryStage) {
    ...
    private void createHeadingGUI() {
        // header
        Label header = new Label("Admin Panel: Driver");
    ...
    private void createHomeGUI() {
        ...
        customerPanelBtn = new Button("Customer Panel");
        customerPanelBtn.setOnAction(this);

        // init all horizontal box
        HBox orderHBox = Utils.getFormattedHBox(mainPanelBtn, customerPanelBtn);
    ...
    private void createTable() {
        ...
        TableColumn<Registration, String> column1 = new TableColumn<>("Email");
        column1.setCellValueFactory(new PropertyValueFactory<>("email"));

        TableColumn<Registration, String> column2 = new TableColumn<>("Phone");
        column2.setCellValueFactory(new PropertyValueFactory<>("phone_num"));

        TableColumn<Registration, String> column3 = new TableColumn<>("The area it serves");
        column3.setCellValueFactory(new PropertyValueFactory<>("address"));

        TableColumn<Registration, String> column4 = new TableColumn<>("Registration ID");
        column4.setCellValueFactory(new PropertyValueFactory<>("rest_id"));
        ...
        for (Registration reg : new RegistrationDAO().findAll()) {
            tableView.getItems().add(reg);
    ...
    public void handle(ActionEvent event) {
        ...
        if (event.getSource().equals(customerPanelBtn)) {
